...
namespace TournamentApi.Migrations
{
    ...
    [Migration("20260103000107_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Bracket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Entities.TournamentParticipant", b =>
                {
                    b.Property<int>("TournamentId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Entities.Bracket", b =>
                {
                    b.HasOne("Entities.Tournament", "Tournament")
                        .WithOne("Bracket")
                        .HasForeignKey("Entities.Bracket", "TournamentId")
            ...
            modelBuilder.Entity("Entities.Match", b =>
                {
                    b.HasOne("Entities.Bracket", "Bracket")
                        .WithMany("Matches")
                        .HasForeignKey("BracketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.User", "Player1")
                        .WithMany("MatchesAsPlayer1")
                        .HasForeignKey("Player1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.User", "Player2")
                        .WithMany("MatchesAsPlayer2")
                        .HasForeignKey("Player2Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.User", "Winner")
